...
export const FALLBACK_TIMELINE: TimelineStep[] = [
  ...
  },
  {
    ...
    title: "REGISTRATIONS",
    subtitle: "",
    description: "Registrations will open shortly for interested students. Team size, eligibility criteria, registration process, and participation guidelines will be announced along with the registration portal. Whether participating individually or as a team, this marks the beginning of your innovation journey.",
    quote: "Opening Soon",
    quoteAuthor: "To Be Announced",
  ...
  },
  {
    ...
    milestone: "Selected for Makeathon"
  },
  {
    id: "t4",
    order: 3,
