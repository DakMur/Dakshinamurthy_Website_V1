  ...
  return (
    <div className="space-y-8 md:space-y-10 mt-8 md:mt-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5 max-w-4xl mx-auto">
        {/* Science, Experienced */}
        <div className="glass-panel rounded-xl p-5 md:p-6 space-y-2.5">
          ...
          <p className="text-sm text-gold-vintage/70 italic font-display mt-1">Don't just learn science. Experience it.</p>
        </div>
        ...
        <div className="glass-panel rounded-xl p-5 md:p-6 space-y-2.5">
          ...
          <p className="text-sm text-slate-400 italic font-serif">From ideas to things you can build.</p>
          <p className="text-sm text-slate-300 leading-relaxed font-sans">
            Makerspaces and innovation around robotics, AI, AR/VR, IoT, rapid prototyping, and emerging technologies. Build → Test → Learn → Improve.
          </p>
        </div>
        ...
        <div className="glass-panel rounded-xl p-5 md:p-6 space-y-2.5">
          ...
          <p className="text-sm text-gold-vintage/70 italic font-display mt-1">Different disciplines. One space for discovery.</p>
        </div>
        ...
        <div className="glass-panel rounded-xl p-5 md:p-6 space-y-2.5">
          ...
          <p className="text-sm text-gold-vintage/70 italic font-display mt-1">Question. Explore. Experiment. Discover.</p>
        </div>
      </div>

      {/* The Param Vision — full width closing */}
      <div className="max-w-3xl mx-auto text-center space-y-3 glass-panel-gold rounded-xl p-6 md:p-8">
        ...
        <p className="text-sm md:text-base text-slate-400 italic font-serif">Nurturing curiosity. Connecting knowledge. Creating possibilities.</p>
        <p className="text-sm md:text-base text-slate-300 leading-relaxed font-sans">
          Creating meaningful experiences that connect India's heritage with future possibilities — environments where people can explore, question, create, collaborate, experiment, and imagine.
        </p>
        ...
        <p className="font-display text-base md:text-lg text-gold-vintage tracking-wide italic">
          Knowledge should be lived, not just learned.
        </p>
      </div>
    ...
    <div className="space-y-8 md:space-y-10">
      ...
      <div className="space-y-2 max-w-3xl mx-auto text-center">
        ...
        <div className="glass-panel rounded-xl p-5 md:p-6 max-w-2xl mx-auto mt-5">
          ...
          <li className="flex items-start gap-2.5">
            <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-gold-vintage/50 flex-shrink-0" />
            <span>Explore Generative AI and its applications in generating images, videos, and more in the upcoming workshop conducted by Param Foundation.</span>
          </li>
          <li className="flex items-start gap-2.5">
            <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-gold-vintage/50 flex-shrink-0" />
      ...
      {/* Workshop Chapter Cards — consistent grid with equal height */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-5 max-w-5xl mx-auto auto-rows-fr">
        {WORKSHOP_CHAPTERS.map((chapter) => (
          <ChapterCard
            key={chapter.number}
            chapter={chapter}
